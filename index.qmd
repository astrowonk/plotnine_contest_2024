...
The raw data files to prepare this are several gigabytes of parquet data. This quarto doc will run from 2 relatively small parquet files, but one is still too big for github. A standalone zip file of the parquet files needed to reproduce the figures is [here](https://marcoshuerta.com/).
